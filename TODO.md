...
这份上线总控清单顶部已经整理为“上线看板”，集中列出当前未完成工作、项目负责人需要准备的资源、我拿到资源后可以继续完成的事项，以及最短上线顺序。资源侧包括域名、VPS、PostgreSQL、AI Key、邮件服务、微信/支付宝收款码、套餐规则、管理员和合规文本；代码侧后续施工、真实环境验收和灰度运营也按 P0/P1/P2 拆好。
