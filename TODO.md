...
这份上线总控清单已经按“当前结论 → 未完成工作总览 → 你需要做的事情 → 我可以继续完成的事情 → 上线 TODO 总表 → 最短上线顺序”重整。资源侧包括域名、VPS、PostgreSQL、AI Key、邮件服务、微信/支付宝收款码、套餐规则、管理员和合规文本；代码侧后续施工、真实环境验收和灰度运营也按 P0/P1/P2 拆好。
